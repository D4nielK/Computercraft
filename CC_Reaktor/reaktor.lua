...
local function drawStatsLive()
  ...
  write(monL, x+16, y+7,   string.format("%4.0f mB/t", r.getMaxBurnRate()))
  write(monL, x+16, y+8,   string.format("%4.1f mB/t", r.getBurnRate()))
  write(monL, x+16, y+9,   string.format("%4.0f K", r.getTemperature()))
